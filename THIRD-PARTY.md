...
|---|---|---|
| Ladder | v0.0.23, snapshot | [GPL-3.0](https://github.com/everywall/ladder) |
...
| Mozilla Readability | snapshot | [Apache-2.0](https://github.com/mozilla/readability); licence and notice in web/vendor |
