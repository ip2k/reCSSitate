...
- iOS 26.5 simulator, iPhone 17 Pro: native WKWebView with an ephemeral cookie
  ...
  26.5 User-Agent. A test-only content rule reproduced a news site’s
...
- Isolated Chromium with a mobile device profile: the generated bookmarklet
  navigated from articles from two news sites, using one cookie jar. The
...
- Backend: A live article fetch returned in roughly 3.5 seconds. FlareSolverr logs confirmed
